        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    @endif
                    <a href="http://localhost/webshop/public/admin/product/create"><button class="btn btn-primary">THÊM SẢN PHẨM MỚI</button></a><br><br>
                    <a href="http://localhost/webshop/public/admin/orderlist"><button class="btn btn-success">Hóa Đơn Đặt Hàng</button></a><br><br>
