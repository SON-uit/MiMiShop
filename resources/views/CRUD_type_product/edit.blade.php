        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                  @if(Session::has('typeproduct_edit'))
                      <div class="alert alert-success" role="alert">
                          {{ Session::get('typeproduct_edit') }}
                      </div>
                  @endif
                    <form action="{{ route("typeproduct_edit") }}"method="POST" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" name="file" id="import" class="form-control" multiple="a">
                          @error('image')
                              <div class="alert alert-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </div>
